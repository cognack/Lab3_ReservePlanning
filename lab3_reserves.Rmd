...
3. Is there a spatial pattern in the planning unit cost values (hint: use `plot` to make a map)?
  - Response: Yes. A grouping of high values occur in a strip in the middle. East of the high cost values are very low values and west of the strip are middle range cost values.
```
...
1. What part of the study area is the 13th vegetation class found in (hint: make a map)? For instance, is it in the south-eastern part of the study area?
   - The 13th vegetation class is found in the north-east corner of the study area
